...
public class SwitchButton extends View implements Checkable {
     ...
     * 6.点击切换
     **/
    private final int overLap = dp2pxInt(10);
...
//        height = h - viewPadding - viewPadding;
        ...
        buttonMaxX = right - width / 2 + viewRadius - viewPadding - overLap / 2;
...
//        canvas.drawCircle(x, y, buttonRadius, buttonPaint);
        ...
        float b = bottom;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            canvas.drawRoundRect(l, t, r, b, (t + b) / 2, (t + b) / 2, buttonPaint);
        } else {
            rect.set(left, top, right, bottom);
        ...
        switch (actionMasked) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if (isPendingDragState()) {
                    ...
                    //拖动按钮位置，同时改变对应的背景颜色
                    float fraction = eventX / getWidth();
                    Log.e("TAG", "onTouchEvent: " + fraction);
                    fraction = Math.max(0f, Math.min(1f, fraction));
