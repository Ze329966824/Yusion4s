...
public class ApplyActivity extends BaseActivity {
    ...
    private void initView() {
        ...
        initTitleBar(this, "创建客户").setTitleBackground(getResources().getColor(R.color.bg_color)).setLeftImageResource(R.mipmap.create_finish_icon).setLeftClickListener(new View.OnClickListener() {
            @Override
