...
//        private LinearLayout client_relationship_lin;//车主与申请人关系
        client_relationship_lin = (LinearLayout) view.findViewById(R.id.client_relationship);
...
//                intent.putExtra("isHasLender", (Parcelable) item.auth_credit.lender);
                //data.getStringExtra("isHasLender")
                if (data.getStringExtra("isHasLender").equals("1")) { //不等于空是1 等于空是2
