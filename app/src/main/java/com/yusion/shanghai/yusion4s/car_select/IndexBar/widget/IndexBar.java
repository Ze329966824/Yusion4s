package com.yusion.shanghai.yusion4s.car_select.IndexBar.widget;
...
import com.yusion.shanghai.yusion4s.car_select.IndexBar.helper.IIndexBarDataHelper;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(Color.parseColor("#ff8867"));
