package com.yusion.shanghai.yusion4s.car_select.suspension;
...
/**
 * 如果数据源isShowSuspension()返回false则无效
 */
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    private static int COLOR_TITLE_BG = Color.parseColor("#fff5f7f9");
    private static int COLOR_TITLE_FONT = Color.parseColor("#ff222a36");
